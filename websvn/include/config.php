...
//
//$config->setSVNCommandPath('C:\Program Files (x86)\Subversion\bin'); //  e.g. c:\\program files\\subversion\\bin
...
//
//$config->addRepository('JJ', 'file:///home/svn/jj');
...
//
//$config->addRepository('J+J Solutions', 'svn://www.xmtek.net/jj', null, 'ryan', 'hummer01');
//$config->addRepository('Grant Instructor', 'svn://www.xmtek.net/grants', null, 'ryan', 'hummer01');
